        ...
        <form method="POST" action="{{ route('admin.album.update', $album->id) }}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <select id="status" name="status" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    <option value="1" {{ $album->status == 1 ? 'selected' : '' }}>Aktív</option>
                    <option value="0" {{ $album->status == 0 ? 'selected' : '' }}>Inaktív</option>
                </select>
                @error('status')
                    <div class="text-red-700">{{ $message }}</div>
                @enderror
            ...
            <div class="mb-6">
                ...
                <input type="number" id="position" name="position" value="{{ $album->position }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                @error('position')
                    <div class="text-red-700">{{ $message }}</div>
                @enderror
            </div>
